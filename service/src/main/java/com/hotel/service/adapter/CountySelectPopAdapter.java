...
public class CountySelectPopAdapter extends BaseAdapter {

    private ArrayList<HashMap<String, String>> spinnerValue;
    private Context context;
    private String TAG = CountySelectPopAdapter.class.getCanonicalName();

    private PopMenuCallback pcb;


    public CountySelectPopAdapter(Context con, ArrayList<HashMap<String, String>> spinnerValue, PopMenuCallback pcb) {
        this.context = con;
        this.pcb = pcb;
...
//		holder.spinnerID.setText(t.get("id"));
        ...
        holder.spinnerName.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String countyName = t.get("name");
//				Toast.makeText(context, countyName, Toast.LENGTH_LONG).show();

                Log.i(TAG, "选择区县名称=======================" + countyName);

                pcb.getCommunityList(countyName);
