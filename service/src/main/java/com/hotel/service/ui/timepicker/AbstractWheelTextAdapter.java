...
//	public static final int DEFAULT_TEXT_COLOR = 0xFF101010;
	public static final int DEFAULT_TEXT_COLOR = R.color.grey;
	...
	private String TAG = AbstractWheelTextAdapter.class.getCanonicalName();
	...
	protected abstract CharSequence getTimeItemText(int index);

	public View getItem(int index, View convertView, ViewGroup parent) {
		
		//Log.i(TAG, "AbstractWheelTextAdapter -> getItem");
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				//Log.i(TAG, "AbstractWheelTextAdapter -> getItem ֵ"+text);
	...
	private View getView(int resource, ViewGroup parent) {
		...
		//Log.i(TAG, "AbstractWheelTextAdapter -> getView");
