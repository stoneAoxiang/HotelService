 ...
 */
public class WorkGuideContentActivity extends BaseFragmentActivity {

    private String TAG = WorkGuideContentActivity.class.getCanonicalName();
    ...
    private void setContent() {
        ...
        Picasso.with(WorkGuideContentActivity.this).load(Tools.getPicUrl(imgUrl, ConstantValue.IMG_PRODUCT_DETAIL_WIDTH, ConstantValue.IMG_PRODUCT_DETAIL_HEIGHT))
