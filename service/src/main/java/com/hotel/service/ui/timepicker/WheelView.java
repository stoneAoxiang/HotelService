...
public class WheelView extends View {
	...
	private String TAG = WheelView.class.getCanonicalName();
	...
	public WheelView(Context context, AttributeSet attrs, int defStyle) {
		...
		//Log.i(TAG, "WheelView->WheelView(Context context, AttributeSet attrs, int defStyle)"); 
		initData(context);
	}
	...
	public WheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		//Log.i(TAG, "WheelView->WheelView(Context context, AttributeSet attrs)"); 
		initData(context);
	}
	...
	public WheelView(Context context) {
		...
		//Log.i(TAG, "WheelView->WheelView(Context context)"); 
		initData(context);
	}
	...
	public void setViewAdapter(WheelViewAdapter viewAdapter) {
		if (this.viewAdapter != null) {
			//Log.i(TAG, "WheelView -> setViewAdapter() -> unregisterDataSetObserver() ===============================");
			this.viewAdapter.unregisterDataSetObserver(dataObserver);
		}
		this.viewAdapter = viewAdapter;
		if (this.viewAdapter != null) {
			//Log.i(TAG, "WheelView -> setViewAdapter() -> registerDataSetObserver() ===============================");
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.mipmap.timer_scroll_picker_bar);
		}
...
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		//Log.i(TAG, "ITEM_OFFSET_PERCENT=============="+ITEM_OFFSET_PERCENT);
		//Log.i(TAG, "�ؼ��ĸ߶�ֵ=============="+desired);
		//Log.i(TAG, "�ؼ��ĸ߶�ֵ=============="+getSuggestedMinimumHeight());
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//Log.i(TAG, "WheelView->onMeasure() ->buildViewForMeasuring()");
...
//			drawCenterRect(canvas);
	...
	private boolean rebuildItems() {
		//Log.i(TAG, "WheelView->rebuildItems()");
	...
	private void updateView() {
		...
		//Log.i(TAG, "WheelView->updateView()");
	...
	private void buildViewForMeasuring() { 
		...
		for (int i = currentItem + addItems; i >= currentItem - addItems; i--) {
			...
			//Log.i(TAG, "WheelView->buildViewForMeasuring() -> addViewItem(i, true)");
			if (addViewItem(i, true)) {
				firstItem = i;
			}
		}
	...
	private boolean addViewItem(int index, boolean first) {
		...
		//Log.i(TAG, "WheelView->addViewItem() -> getItemView()");
	...
	private View getItemView(int index) {
		...
		if (!isValidItemIndex(index)) {
			...
			//Log.i(TAG, "WheelView->getItemView() -->  viewAdapter.getEmptyItem()");
		...
		//Log.i(TAG, "WheelView->getItemView() -->  viewAdapter.getItem()");
