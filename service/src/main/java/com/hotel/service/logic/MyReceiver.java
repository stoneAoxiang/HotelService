...
//        	context.startActivity(i);
			...
			//推送信息类型
			String noticeType = new String();

			try {
				jsonObject = new JSONObject(bundle.getString(JPushInterface.EXTRA_EXTRA));
//				noticeType = jsonObject.getString("type");

				//1代表公告信息
//				if(noticeType.equals("1")){
					Intent i = new Intent(context, ServiceBulletinActivity.class);
					i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//					i.putExtra("noticeID", jsonObject.getString("id"));
					context.startActivity(i);
//				}
