...
public class DialogHelper {
    ...
    public static void Confirm(Context ctx, CharSequence title, CharSequence message,
      ...
      Confirm(ctx, title, message, okText, oklistener, cancelText, cancellistener, false);
    }
    ...
    public static void Confirm(Context ctx, int titleId, int messageId,
                               ...
                               OnClickListener cancellistener) {
        Confirm(ctx, ctx.getText(titleId), ctx.getText(messageId), ctx.getText(okTextId), oklistener, ctx.getText(cancelTextId), cancellistener, false);
    }

    public static void Confirm(Context ctx, int titleId, int messageId,
                               int okTextId, OnClickListener oklistener, int cancelTextId,
                               OnClickListener cancellistener, boolean cancelAble) {
        Confirm(ctx, ctx.getText(titleId), ctx.getText(messageId), ctx.getText(okTextId), oklistener, ctx.getText(cancelTextId), cancellistener, cancelAble);
    }

    public static void Confirm(Context ctx, String title, int messageId,
                               int okTextId, OnClickListener oklistener, int cancelTextId,
                               OnClickListener cancellistener, boolean cancelAble) {
        Confirm(ctx, title, ctx.getText(messageId), ctx.getText(okTextId), oklistener, ctx.getText(cancelTextId), cancellistener, cancelAble);
    }
